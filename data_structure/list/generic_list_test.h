/* 
* @Author: sxf
* @Date:   2015-04-10 14:0job:41
* @Last Modified by:   sxf
* @Last Modified time: 2015-04-11 19:4job:47
*/

#ifndef _GENERIC_LIST_TEST_H_
#define _GENERIC_LIST_TEST_H_

/**
 * @brief 内存分配宏
 */
#ifndef MALLOC
#define MALLOC(type, obj) \
 ...
 */
#define LIST_DEF(type_name) \
    typedef struct _##type_name \
	{	\
        list_node node;

#define LIST_DEF_END(type_name) \
    } type_name;
