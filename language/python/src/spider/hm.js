(function() {
  var h = {},
    mt = {},
    c = {
      id: "7ed65b1cc4b810e9fd37959c9bb51b31",
      dm: ["kuaidaili.com"],
  ...
  (mt.h.Ga = function() {
    ...
    (function() {
      if (!d)
        if (d = r, "complete" === document.readyState) a.B = r;
  ...
  (function() {
    ...
    var d = mt.lang,
      ...
      e = {
        ...
        ma: function() {
          if (0 < e.s.length)
            for (var a = 0, d = e.s.length; a < d; a++) e.S(e.s[a]);
          e.s = t
        },
        S: function(a) {
          var b = a[0];
        ...
        _trackRTEvent: function(a) {
          ...
          if (d.d(a, "Object")) {
            ...
            if (900 >= m) g.call(this, a);
              ...
              for (var m = Math.ceil(m / 900), s = "block|" + Math.round(Math.random() * n.R).toString(16) + "|" + m + "|", l = [], v = 0; v < m; v++) l.push(v), l.push(a.substring(900 * v, 900 * v + 900)), g.call(this, s + l.join("|")), l = []
          }
        },
    ...
    a.prototype = {
      ...
      J: function() {
        for (var a = document.location.hostname, b = 0, d = c.dm.length; b < d; b++)
          if (this.P(a, c.dm[b])) return c.dm[b].replace(/(:\d+)?[\/\?#].*/, "");
        return a
      },
      W: function() {
