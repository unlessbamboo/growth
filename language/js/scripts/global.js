...
function prepareSlideshow() {
    ...
    // 另见layout中关于slideshow, frame, privew的样式
...
/*
 * 1 根据<a>找到所有的下方section
 * 2 默认显示第一个section, 将其他section隐藏
 */
function prepareInternalnav() {
    ...
    for (var i=0; i<links.length; i++ ) {
      ...
      if (!document.getElementById(sectionId) || i==0) continue;
