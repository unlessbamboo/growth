...
flags = [
    ...
    # headers will be compiled as C headers. You don't want that so
    ...
    '../BoostParts',
    '-isystem',
    # This path will only work on OS X, but extra paths that don't exist 
    # are not harmful
    ...
    '/usr/local/include/',
    '-isystem',
    '/usr/src/linux-headers-4.4.0-34/include/linux/',
]
...
def GetCompilationInfoForFile(filename):
    """
        ...
        corresponding source file, if any. If one exists, 
